...
// let spacecratName: string= 'Determination';
...
//     return days
// }
// console.log(` ${spacecratName} would take ${getDaysToLocation(kilometersToMars)} days to get to Mars.`)
// console.log(`${spacecratName} would take ${getDaysToLocation(kilometersToTheMoon)} days to get to Moon`)
